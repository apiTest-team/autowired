...
import {
  ...
  getProvideName,
  getProvideUUID, getObjectDefinition,
  getPropertyAutowired, getClassMetadata, ConfigurationOptions, saveProvideId, listModule, saveModule
} from "../decorator";
import { Types, randomUUID, extend } from "../utils";
import { ObjectDefinition,FunctionDefinition } from "../definitions";
...
class ContainerConfiguration {
  ...
  constructor(readonly container: IAutowiredContainer) {}
