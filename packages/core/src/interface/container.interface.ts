...
export interface IObjectCreator {
  load(): any;
  doConstruct(Clazz: any, args?: any, context?: IAutowiredContainer): any;
  doConstructAsync(
    Clazz: any,
    args?: any,
    context?: IAutowiredContainer
  ): Promise<any>;
  doInit(obj: any): void;
...
export interface IFileDetector {
  run(container: IAutowiredContainer, fileDetectorOptions?: Record<string, any>);
 ...
 * 对象容器定义
 */
export interface IAutowiredContainer extends IObjectFactory,IObjectLifeCycle {
  // 父级容器
  parent: IAutowiredContainer
  // 标识映射关系
